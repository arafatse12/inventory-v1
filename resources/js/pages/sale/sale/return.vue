                    ...
                    <form class="form-horizontal"  @submit.prevent="submitSale(formObject)">
                        <div class="box-header with-border" style="padding-bottom: 0px;">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="col-md-4">
                                        <h3 class="box-title text-primary"><i class="fa fa-shopping-cart text-aqua"></i> Sales Return</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    export default {
        ...
        methods: {
			submitSale(formObject){
				...
				let URL = baseUrl +'/'+ "sales-return/"+saleId;
             ...
             let saleId = this.$route.params.saleId;
              let URL = baseUrl +'/'+ "get-by-sale-id-details?sale_id=" + saleId;
                ...
                .then((response) => {
                    ...
                    this.$set(_this.formObject, "due",salesInformation.due);
                    this.calulation();
            });
